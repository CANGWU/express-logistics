...
public class FreeProgressBar extends JProgressBar {
    ...
    private ImageIcon selectedBackgroundImageIcon = TWaverUtil.getImageIcon(selectedBackgroundImageURL);
    ...
    protected void paintComponent(Graphics g) {
        ...
        paintShape(g2d, allShape, allShape,
                this.unselectedPaint, this.unselectedBorderColor,
                null, null);

        //paint selected shape.
        Shape selectedShape = this.getSelectedShape();
        paintShape(g2d, allShape, selectedShape,
                this.selectedPaint, this.selectedBorderColor,
                selectedBackgroundLeft, selectedBackgroundRight);
        ...
        int y = (int) ((this.getHeight() - bounds.getHeight()) / 2)
                + g2d.getFontMetrics().getAscent() + 1;
    ...
    private void paintShape(Graphics2D g2d, Shape shape, Shape clip,
            Paint fillPaint, Color borderColor,

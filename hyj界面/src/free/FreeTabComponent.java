...
public class FreeTabComponent extends JPanel {
    ...
    private ImageIcon pressedIcon = FreeUtil.getImageIcon("tab_close_pressed.png");
    private Image unselectedLeftImage = FreeUtil.getImage("tab_header_unselected_background_left.png");
    private Image unselectedRightImage = FreeUtil.getImage("tab_header_unselected_background_right.png");
    private Image selectedLeftImage = FreeUtil.getImage("tab_header_selected_background_left.png");
    private Image selectedRightImage = FreeUtil.getImage("tab_header_selected_background_right.png");

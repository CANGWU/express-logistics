				...
				if(e.getSource() instanceof JLabel){
					...
					if(title.equals("人员管理")){
						...
						try{
							...
							pManagementPage = PManagementPanel.createPManagementPage(tab);
						...
						try{
							...
							aManagementPage = AManagementPanel.createAManagementPage(tab);
						...
						try{
							...
							reportPage = ReportPanel.createReportPage(tab);
						...
						try{
							...
							constantPage = ConstantPanel.createConstantPage(tab);
						...
						try{
							...
							salaryStrategyPage = SalaryStrategyPanel.createSalaryStrategyPage(tab);
						...
						try{
							...
							logPage = LogPanel.createLogPage(tab);

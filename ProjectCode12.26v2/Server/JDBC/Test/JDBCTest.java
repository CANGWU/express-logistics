...
// sendDataImpl.deleteReceiptsPO("dasd", " da");
  FinanceDataService financeDataService = datafactory.getFinanceData();
  
  PaymentPO paymentPO = new PaymentPO();
//  paymentPO.setAuditnumber("312");
//  paymentPO.setCondition(DocumentCondition.audited);
//  paymentPO.setType(PaymentType.Bonus);
//  
//  financeDataService.insertPaymentPO(paymentPO);
  paymentPO = financeDataService.findLastest();
  System.out.println(paymentPO.getAuditnumber());

...
public class ReceiveService_Stub implements ReceiveService {
	...
	public OrderVO addExpress(String name, String time, String orderNumber) {
		// TODO Auto-generated method stub
		return new OrderVO(orderNumber, orderNumber, orderNumber, orderNumber,
				orderNumber, orderNumber, orderNumber, orderNumber,
				orderNumber, orderNumber, orderNumber, orderNumber, 0, 0, 0,
	...
	public void saveExpress(OrderVO ordervo) {
		// TODO Auto-generated method stub
		// OrderPO po=new
		// OrderPO(ordervo.getName(),ordervo.getTime(),ordervo.getID());

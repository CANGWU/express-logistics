...
//		userManagementPanel.add(seekUser);
	...
	private static void createSeekReceiptsPanel(){
		...
		JTextField officefield=new JTextField(10);
		...
		submit.addMouseListener(new MouseAdapter(){
		    ...
		    {       
		    	...
		    	if(!datefield.getText().equals("")&&!officefield.getText().equals("")){
			        BalanceController bc=new BalanceController();
			        volist=bc.getBalanceMessage(datefield.getText(), officefield.getText());

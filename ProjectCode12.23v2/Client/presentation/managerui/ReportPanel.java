...
public class ReportPanel {
	...
	private static FreeReportPage createReportPage() {
		...
		DateChooser beginDateFiled=new DateChooser(page);		
		JLabel overDate=new JLabel("结束");
		DateChooser overDateField=new DateChooser(page);
		...
		seek.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					reportVO=reportService.addMessage(idNumberField.getText(), beginDateFiled.getText(), overDateField.getText());
				} catch (Exception e) {

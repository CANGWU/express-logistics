...
public class SalaryStrategyPanel {
	...
	public static FreePagePane createSalaryStrategyPage(FreeTabbedPane tab) {
		try {
			salaryStrategyService=new SalaryStrategyController(new SalaryStrategy(DataFactory.create()));

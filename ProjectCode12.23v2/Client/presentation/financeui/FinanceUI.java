...
public class FinanceUI extends StaffUI {
    ...
    private FreeStatusLabel lbServer = createStatusLabel("服务端IP（未实现）", "/free/test/server.png");
    private FreeStatusLabel lbUser = createStatusLabel("财务人员", "/free/test/user.png");

...
public class TransportDataImpl extends UnicastRemoteObject implements TransportDataService,Serializable{
	...
	public ResultMessage insert(TransportPO po){
		String sql = "insert into transportpo values('"+po.getSign()+"','"+po.getID()+"','"+po.getDeparture()+"','"+po.getDestination()+"','"
				+po.getTransportID()+"','"+po.getTime()+"','"+po.getTrafficID()+"','"+po.getTrafficType()+"',"+po.getfare()+",?,?,?,'"

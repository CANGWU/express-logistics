...
public class AdminUI extends StaffUI{

    private String menuBarXML = "/free/menubar.xml";
    private String toolbarXML = "/free/toolbar.xml";
    private String outlookPaneXML = "/adminui/adminoutlook.xml";
    ...
    private FreeStatusLabel lbServer = createStatusLabel("服务器IP（暂未实现）", "/free/test/server.png");
    private FreeStatusLabel lbUser = createStatusLabel("管理员", "/free/test/user.png");
...
//                	bar.setSelected(true);
                	...
                	if(title.equals("用户管理")){
                        ...
                        try{
                            tab.setSelectedComponent(userManagementPage);

                           }catch(Exception ex){
                        	   userManagementPage=UserManagementPanel.createUserManagementPage(tab,userId);
                               tab.add(title, userManagementPage);
                               tab.setSelectedComponent(userManagementPage);
                           }

...
public class PManagementStub implements PManagementService{
	...
	public StaffVO select(String id) {
		...
		return new StaffVO("张三", "司机", "020001003", "020001", "1980/2/2", "23712314843724", "137137223728", "南京市栖霞区仙林大道162�?", "�?", 4000);
	}
	...
	public ArrayList<StaffVO> getAllStaff() {
		...
		staff.add(new StaffVO("张三", "司机", "020001003", "020001", "1980/2/2", "23712314843724", "137137223728", "南京市栖霞区仙林大道162�?", "�?", 4000));
		return staff;
	}
